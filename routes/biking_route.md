...
### Canyon Boulevard Corridor (Highlight)
The **Canyon Boulevard** segment is Boulder's premier bicycle infrastructure. Features:
- Dedicated, separated bike lane (not just sharrows)
- Width: ~2.0 m bike lane with buffer
- Signal priority: Bike-specific signal phases at major intersections
- Surface: Freshly repaved with glass-bead marking for wet-day grip
- Lighting: Street lights along full length for evening commute

### Route Characteristics
- **Flat:** Max 15 m total elevation gain — no hills
- **Direct:** Most routes between these points follow essentially the same path
