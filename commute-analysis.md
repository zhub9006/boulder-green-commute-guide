...
### Route Segments (shared by walking & biking)
...
| 18th Street | 248.8 m | ~30 sec | ~15 sec | Downtown approach |
| Canyon Boulevard | 636.6 m | ~1 min | ~25 sec | Dedicated separated bike lane — safest segment! |

_Walking pace: 5 km/h (comfortable). Biking pace: 15 km/h (average urban)._

**Total:** 4,027 m (4.03 km)

---

## 🚶 Walking — Full Analysis
...
### Biking Challenges
- **19th Street** — 2,157 m on a busy arterial (54% of route); dooring risk in painted bike lane
...
## 🔀 Walking vs Biking — Decision Matrix
...
- **Walking distance (raw):** 4,026.5 m — verified against OSM geometry
- **Biking distance (raw):** 4,026.5 m — same route topology
- **Elevation:** ~5,430 ft at origin → ~5,400 ft at destination (~30 m descent)
- **NO₂ & CO₂:** US EPA emission factors for passenger vehicles
- **RTD bus routes:** RTD Boulder system (routes 1, 3, 7, 10)
- **Raw route geometry:** See [routes/route_data.json](routes/route_data.json) for complete coordinate arrays
- **Last verified:** July 18, 2026

---

*Route data verified against live OpenStreetMap routing engine on 2026-07-18. Segment distances and street names confirmed OSM-derived. Review [verified_route_data.md](verified_route_data.md) for full API response data.*
